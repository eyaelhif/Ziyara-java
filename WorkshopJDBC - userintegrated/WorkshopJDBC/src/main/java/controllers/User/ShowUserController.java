...
public class ShowUserController {
    ...
    private services.statuserService statuserService;
    ...
    void addUser(ActionEvent event) {
        try {
            // Load the FXML file
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Back/User/addUser.fxml"));
    ...
    public void goToNavigate(ActionEvent actionEvent) {
        try {
            // Load the FXML file
            Parent root = FXMLLoader.load(getClass().getResource("/Back/back.fxml"));

            // Get the current scene
            Scene currentScene = ((Node) actionEvent.getSource()).getScene();

            // Set the root of the current scene to the loaded FXML content
            currentScene.setRoot(root);
        } catch (IOException e) {
            e.printStackTrace();
            // Handle the exception if the FXML file is not found or cannot be loaded
        }
    }
}
