...
*/
    ...
    private void updateVisites(String filter) {
        ...
        for (Visite visite : filteredVisites) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/CardVisiteFXML.fxml"));
    ...
    public void Myres(ActionEvent actionEvent) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ListeReservationVisiteUserFXML.fxml"));
            Parent root = loader.load();
