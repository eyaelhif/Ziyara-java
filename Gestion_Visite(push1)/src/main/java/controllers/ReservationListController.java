...
public class ReservationListController {
    ...
    void addReservation(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AjoutReservationVisiteFXML.fxml"));
    ...
    void modifierReservation(ActionEvent event) {
        ...
        if (selectedReservation != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/ModifReservationVisiteFXML.fxml"));
                Parent root = loader.load();
