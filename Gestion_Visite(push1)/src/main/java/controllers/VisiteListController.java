...
// Set a custom cell factory to display images in the imageColumn
    ...
    void addVisite(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AjoutVisiteFXML.fxml"));
    ...
    void modifierVisite(ActionEvent event) {
        ...
        if (selectedVisite != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/ModifVisiteFXML.fxml"));
                Parent root = loader.load();
    ...
    public void gotofront(ActionEvent actionEvent) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ListeVisiteUserFXML.fxml"));
            Parent root = loader.load();
